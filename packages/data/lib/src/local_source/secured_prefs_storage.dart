...
class SecuredPrefsStorage {
  SecuredPrefsStorage._privateConstructor();
  static final SecuredPrefsStorage _instance = SecuredPrefsStorage._privateConstructor();

  static final FlutterSecureStorage _secureStorage = const FlutterSecureStorage(
    aOptions: AndroidOptions(
      encryptedSharedPreferences: true, // Use secured storage on Android
    ),
  );

  static SecuredPrefsStorage getInstance() => _instance;
